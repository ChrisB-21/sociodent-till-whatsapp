      ...
      <main className="flex-grow pt-20">
        <div className="container-custom py-12">
          ...
          <div className="flex items-center text-sm mb-8">
            <Link to="/products" className="text-gray-500 hover:text-sociodent-600 flex items-center">
...
/*          <div className="mt-16">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link to="/products" className="text-sociodent-600 font-medium flex items-center hover:text-sociodent-700">
                View All Products
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6">
              {relatedProducts.map(relatedProduct => (
                <div key={relatedProduct.id} className="glass-card rounded-2xl overflow-hidden card-hover">
                  ...
                  <div className="p-4">
                    <Link to={`/products/${relatedProduct.id}`} className="hover:text-sociodent-600 transition-colors">
